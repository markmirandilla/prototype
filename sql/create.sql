...
`account_phone` VARCHAR( 45 ) NULL ,
`account_mobile_phone` VARCHAR( 45 ) NULL ,
`account_fax` VARCHAR( 45 ) NULL ,
`account_date_created` DATETIME NOT NULL ,
`account_date_updated` TIMESTAMP ON UPDATE CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
INDEX (  `country_id` ) ,
UNIQUE (
`account_name`
)
